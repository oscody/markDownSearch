...
file_count = 0
file_limit = 1759  # or None for no limit
output_file = 'ollamaHashtagsV6.md'

# 2. Prompt template
prompt_template = """
Please analyze the following text and strictly adhere to the instructions below:
1. Purpose:
   - Identify exactly 2 hashtags that summarize the content, capture key themes, or optimize for searchability.
