...
1. Purpose:
- Identify exactly 2 hashtags that are the most common and reflect the content the most. Select hashtags that are highly relevant to the themes, topics, or key phrases in the text.
2. Output:
- Output only the 2 hashtags on a single line, separated by a single space.
...
3. Examples of content with hashtags:
- Content: "How to learn Python for AI development and create an AI web scraper." 
  Hashtags: #PythonAI #WebScraping
- Content: "Tips for starting your software development career with online courses and training."
  Hashtags: #SoftwareDevelopmentCareer #OnlineCourses
4. Text to analyze:
{}
"""
...
class HashtagAggregator:
    ...
    def combine_hashtags(self, content: str) -> list:
        """
